      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">
            Über <span className="text-primary">GreenCircle</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
              GreenCircle CSC wurde 2019 gegründet mit dem Ziel, eine professionelle 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="p-6 text-center hover:shadow-medium transition-all duration-300 bg-gradient-card border-border/50">
